...
export default function WorkTimeline() {
  return (
    <section className="py-12 sm:py-16 bg-[#F8FAFC] border-t border-slate-200" id="experience">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {WORK_EXPERIENCES.map((exp, idx) => (
            <div
              key={idx}
              className="clean-card p-4 sm:p-6 rounded-2xl flex flex-col md:flex-row md:items-start justify-between gap-4 sm:gap-6 hover:border-slate-300 transition-colors"
            >
              <div className="md:w-5/12 shrink-0">
                ...
                <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 text-xs text-slate-500 mt-2 font-medium">
              ...
              <div className="md:w-7/12 space-y-2 pt-3 md:pt-0 border-t md:border-t-0 md:border-l border-slate-100 md:border-slate-200 md:pl-6">
